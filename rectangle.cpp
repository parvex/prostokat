...
//////////////////////////////////////////!@#!@#!@#!@
//template<class type>
//Rect& Rect<type>::operator +=(const Rect &rect2) //wpisywanie skrajnych wartosci do wspolrzednych prostokata sumy
//{
//
...
////////////////////////////////////////////////////!@#!!!!!!!!!
//template<class type>
//Rect Rect<type>::operator +(const Rect &rect2) const //wpisywanie skrajnych wartosci do wspolrzednych prostokata sumy
//{
//	Rect sum = *this;
//	sum += rect2;
//
...
//////////////////////////////////////////
//template<class type>
//Rect& Rect<type>::operator -=(const Rect &rect2)
//{
//
...
/////////////////////////////////////////!@#!@#!@#!@
//template<class type>
//Rect Rect<type>::operator -(const Rect &rect2) const
//{
//	Rect substract = *this;
//	substract -= rect2;
//
...
///////////////////////////////////////
//template<class type>
//bool Rect<type>::encloses(const Rect &rect2) const // do poprawienia!!!!!!!! - powinno dzialac
//{
...
//////////////////////////////////////
//template<class type>
//bool Rect<type>::crosses(const Rect &rect2) const//jak lezy w srodku to tez przecina, zmienic?
//{
//	Rect sub = (*this) - rect2;
